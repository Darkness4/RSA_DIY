...
class BigUIntTest : WordSpec({
    "valueOf(\"2147483648\")" should {
        "have a magnitude array of {0, 1}" {
            val result = BigUInt.valueOf("2147483648", radix=10)
    ...
    "basePowK" should {
        "BASE^5" {
            ...
            result shouldBe BigUInt.valueOf("45671926166590716193865151022383844364247891968", 10)
        }
    }
    "plus" should {
        "(-2)u + 2u = 4u" {
    ...
    "modInverse" should {
        "3233 modInverse BASE = 1889" {
            ...
            v shouldBe BigUInt.valueOf("425776993", 10)
        }
    }
